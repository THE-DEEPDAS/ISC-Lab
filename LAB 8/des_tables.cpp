...
// --- S-boxes: 8 boxes, each 4x16 entries ---
...
void key_schedule(uint64_t key64, uint64_t subkeys[16]){
    ...
    for(int r=0;r<16;++r){
        ...
        subkeys[r] = k48; // low 48 bits used
    }
}
}

// Round function prototype (implementation left to students in another file)
extern uint32_t feistel(uint32_t R, uint64_t subkey);